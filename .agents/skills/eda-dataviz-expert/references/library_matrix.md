...
| Library / Tool | Eco | Paradigm | Best For | Output Format | Volume Cap | Interactivity |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Power BI / Tableau** | BI / Enterprise | Self-Serve Semantic / Canvas | Executive reporting, cross-filtering, corporate KPI dashboards | Web App, PDF, Mobile | Enterprise Scale (DirectQuery/VertiPaq) | Native Cross-filtering |
| **Seaborn (v0.13+) [DEFAULT PYTHON]** | Python | High-level Statistical | Rapid statistical EDA, distributions, regressions, boxplots | PNG, SVG, PDF | ~100k rows | None (Static) |
...
## 💻 Idiomatic Code Templates (Preset: `editorial`)
