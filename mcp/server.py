...
from tools.vault.recall import recall as _recall_tool
...
@mcp.tool()
def recall(query: str, filters: dict | None = None, limit: int = 5) -> dict:
    """
    ...
    over search() — it returns ranked signal from both tiers, not raw top-K noise.
