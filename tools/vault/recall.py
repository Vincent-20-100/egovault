"""
Tiered retrieval tool — deterministic.

Orchestrates the two-tier search (compiled notes → raw chunks) into a single
stable RecallContext. No LLM: synthesis is a minimal assembled block,
confidence is None. Tier 1 will upgrade only synthesis quality and confidence.
"""

from core.context import VaultContext
from core.schemas import SearchFilters, RecallSource, RecallContext
...
def recall(
    ...
    """Tiered retrieval: search notes, escalate to chunks if sparse, assemble."""
